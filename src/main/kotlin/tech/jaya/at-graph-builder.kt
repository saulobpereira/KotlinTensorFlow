...
class GraphBuilder(private val graph: Graph) {
    fun div(x: Output<java.lang.Float>, y: Output<java.lang.Float>): Output<java.lang.Float> {
    ...
    fun <T> resizeBilinear(images: Output<T>, size: Output<java.lang.Integer>): Output<java.lang.Float> {
        return binaryOp3("ResizeBilinear", images, size)
    }

    fun <T> expandDims(input: Output<T>, dim: Output<java.lang.Integer>): Output<T> {
    ...
    fun constant(name: String, value: java.lang.Integer): Output<java.lang.Integer>? {
        return constant(name, value, java.lang.Integer::class.java)
    }

    fun constant(name: String, value: IntArray): Output<java.lang.Integer>? {
        return constant(name, value, java.lang.Integer::class.java)
    }

    fun constant(name: String, value: java.lang.Float): Output<java.lang.Float>? {
        return constant(name, value, java.lang.Float::class.java)
    }
